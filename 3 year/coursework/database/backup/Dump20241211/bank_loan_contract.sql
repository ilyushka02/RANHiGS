...
CREATE TABLE `loan_contract` (
  ...
  CONSTRAINT `loan_contract_ibfk_1` FOREIGN KEY (`loan_id`) REFERENCES `loan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `loan_contract_ibfk_2` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
